...
Trilha técnica de APIs e Integrações do Suporte C2S — versão 1.0.
...
Salve o arquivo — o endpoint aparece automaticamente no menu lateral, na busca e ganha sua própria página. Não precisa mexer em `app.js`.
